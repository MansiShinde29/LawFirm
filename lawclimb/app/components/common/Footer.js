...
export const Footer = () => {
  return (
    <>
    <footer id={styles.footer} className={`${styles.footer_1}`} >
  <div className={`${styles.main_footer}`}>
    <div className="container">
      <div className="row text-white">
        <div className="col-xs-12 col-sm-6 col-md-3">
          <div className="widget subscribe no-box">
            <h5 className="widget-title fw-bolder" style={{fontSize:25 , }}>
              COMPANY NAME
              <span />
            </h5>
            ...
            <ul className='text-white'>
              ...
              <li>
                <div className="thumb-content">
                  <a className="text-white" href="#.">Top Leaders</a>
                </div>
              </li>
              <li>
                <div className="thumb-content">
                  <a className="text-white" href="#.">Success Stories</a>
                </div>
              </li>
              <li>
                <div className="thumb-content">
                  <a className="text-white" href="#.">Event/Tickets</a>
                </div>
              </li>
              <li>
                <div className="thumb-content">
              ...
              <li>
                <div className="thumb-content">
                  <a className="text-white" href="#.">Lifestyle</a>
                </div>
              </li>
              <li>
                <div className="thumb-content">
        ...
        <div className="col-xs-12 col-sm-6 col-md-3">
          <div className="text-white">
            <h5 className="text-white fw-bolder " style={{fontSize:25 , }}>
              GET STARTED
              <span />
            </h5>
        ...
        <div className="col-xs-12 col-sm-6 col-md-3">
          <div className="text-white">
            ...
            <p>
              <a  className="text-white link" href="mailto:info@domain.com" title="glorythemes">
                info@domain.com
              </a>
            </p>
